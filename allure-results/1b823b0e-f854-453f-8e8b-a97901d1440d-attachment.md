...
- text: Full Name
- textbox "Full Name": Stacey Lakin
- text: Email
- textbox "name@example.com": test+Megane_Pfannerstill-Boyle5@hotmail.com
- text: Current Address
- textbox "Current Address": 4792 Ferry Road Second Line
- text: Permanent Address
- textbox: 8712 Sycamore Close
- button "Submit"
