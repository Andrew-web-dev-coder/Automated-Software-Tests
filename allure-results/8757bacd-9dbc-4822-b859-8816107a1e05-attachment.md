...
- text: Full Name
- textbox "Full Name": Verna Leuschke
- text: Email
- textbox "name@example.com": test+Nia.Yost@hotmail.com
- text: Current Address
- textbox "Current Address": 452 The Woodlands Second Line
- text: Permanent Address
- textbox: 3725 Roob Creek
- button "Submit"
- iframe
