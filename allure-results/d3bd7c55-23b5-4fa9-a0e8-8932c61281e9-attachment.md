...
- text: Full Name
- textbox "Full Name": Timothy Haag
- text: Email
- textbox "name@example.com": test+Aliza85@gmail.com
- text: Current Address
- textbox "Current Address": 934 Orchard Lane Second Line
- text: Permanent Address
- textbox: 93173 Pine Grove
- button "Submit"
- iframe
