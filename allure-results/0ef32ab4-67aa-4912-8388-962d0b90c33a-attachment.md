...
- text: Full Name
- textbox "Full Name": Camille Deckow
- text: Email
- textbox "name@example.com": test+Golda.Crooks67@yahoo.com
- text: Current Address
- textbox "Current Address": 831 Rosa Plains Second Line
- text: Permanent Address
- textbox: 37864 Samir Crescent
- button "Submit"
