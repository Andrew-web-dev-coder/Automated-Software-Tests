...
Call log:
  - waiting for locator('.css-1uccc91-singleValue').nth(1)

    at C:\Users\aleksandr.shepilov\Desktop\Automated-Software-Tests\tests\specs\selectmenu.spec.js:20:74
```
...
- textbox
- text: Select One
- paragraph: option Other, selected.
- paragraph: 0 results available. Select is focused ,type to refine list, press Down to open the menu,
- text: Other
- textbox
